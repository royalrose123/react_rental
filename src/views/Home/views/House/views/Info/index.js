...
function Info(props) {
  ...
  const { displayName, phoneNumber, gender: postGender } = postUser
          ...
          <div className={cx('info-right')}>
            ...
            <div className={cx('info-right__landlord')}>
              <div className={cx('info-right__landlord-avatar')}>
                ...
                <p className={cx('info-right__landlord-avatar-name')}>{`${displayName.slice(0, 1)}${postGender === '男' ? '先生' : '小姐'}`}</p>
              </div>
              <div className={cx('info-right__landlord-phone')}>
                <Icons.Phone className={cx('info-right__landlord-phone-icon')} />
                <p className={cx('info-right__landlord-phone-number')}>{setPhoneSeparate(phoneNumber)}</p>
              </div>
            </div>
          </div>
        </div>
