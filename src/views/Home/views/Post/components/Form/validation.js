...
export const schema = Yup.object().shape({
  ...
  price: Yup.number().typeError('此欄位為數字').positive('此欄位不接受負數').required('此欄位為必填'),
  ...
  restroomAmount: Yup.number().typeError('此欄位為數字').positive('此欄位不接受負數').required('此欄位為必填'),
  roomAmount: Yup.number().typeError('此欄位為數字').positive('此欄位不接受負數').required('此欄位為必填'),
  roomType: Yup.string().required('此欄位為必填'),
  size: Yup.number().typeError('此欄位為數字').positive('此欄位不接受負數').required('此欄位為必填'),
  street: Yup.string().required('此欄位為必填'),
  surrounding: Yup.string().required('此欄位為必填'),
  title: Yup.string().required('此欄位為必填'),
  totalFloor: Yup.number().typeError('此欄位為數字').positive('此欄位不接受負數').required('此欄位為必填'),
